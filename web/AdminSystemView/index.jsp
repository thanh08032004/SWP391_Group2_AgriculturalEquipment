...
<head>
    ...
    <link rel="shortcut icon" href="${pageContext.request.contextPath}/assetAdminSystem/images/favicon.ico" type="image/x-icon">
    <link href="${pageContext.request.contextPath}/assetAdminSystem/css/bootstrap.min.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/assetAdminSystem/icons/fontawesome/css/fontawesome.min.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/assetAdminSystem/icons/fontawesome/css/brands.min.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/assetAdminSystem/icons/fontawesome/css/solid.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.0/font/bootstrap-icons.css">
    <link href="${pageContext.request.contextPath}/assetAdminSystem/plugin/select2/css/select2.min.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/assetAdminSystem/css/board.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/assetAdminSystem/css/chat.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/assetAdminSystem/css/style.css" rel="stylesheet">
</head>
<body>
    <!-- ========== NAVBAR ========== -->
     <header>
         <nav class="navbar navbar-expand-lg" role="navigation" aria-label="Main navigation">
             <div class="d-flex align-items-center gap-3">
                 ...
                 <a href="index.html" class="navbar-brand">
                     <div class="logo" aria-hidden="true"><img src="${pageContext.request.contextPath}/assetAdminSystem/images/icon-logo.png" alt="logo"></div>
                     <div class="brand-text">
                        <img src="${pageContext.request.contextPath}/assetAdminSystem/images/panelry-logo.png" alt="logo">
                     </div>
                 </a>
             </div>
             <!-- Top nav links -->
                                ...
                                <li>
                                    <div class="timeline-panel">
                                        <div class="media me-2">
                                            DR
                                            <!-- <img alt="image" width="50" src="${pageContext.request.contextPath}/assetAdminSystem/images/profile.png"> -->
                                        </div>
    ...
    <aside class="sidebar" id="sidebar" aria-label="Sidebar navigation">
        <ul class="menu" role="menu">
            <li class="menu-item" role="none">
                <a href="index.html" class="active" role="menuitem" title="Dashboard">
    ...
    <footer class="footer">
        © 2025 Panelry ? All Rights Reserved  <a href="https://www.templaterise.com/" class="text-primary" target="_blank" >Themes By TemplateRise</a>
    </footer>
    <script  src="${pageContext.request.contextPath}/assetAdminSystem/js/jquery-3.6.0.min.js"></script>
    <script  src="${pageContext.request.contextPath}/assetAdminSystem/js/bootstrap.bundle.min.js"></script>
    <script  src="${pageContext.request.contextPath}/assetAdminSystem/plugin/chart/chart.js"></script>
    <script  src="${pageContext.request.contextPath}/assetAdminSystem/plugin/select2/js/select2.min.js"></script>
    <script  src="${pageContext.request.contextPath}/assetAdminSystem/js/chart.js"></script>
    <script  src="${pageContext.request.contextPath}/assetAdminSystem/js/chat.js"></script>
    <script  src="${pageContext.request.contextPath}/assetAdminSystem/js/board.js"></script>
    <script  src="${pageContext.request.contextPath}/assetAdminSystem/js/script.js"></script>
</body>
</html>
...
<html>
    <head>
        <jsp:include page="/common/head.jsp"></jsp:include>
            <title>Add New Voucher - AgriCMS</title>
        </head>
        <body class="bg-light">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8 col-md-10">
                                <div class="card border-0 shadow-sm">
                                    ...
                                    <form action="${pageContext.request.contextPath}/admin-business/vouchers?action=add"
                                          method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="isActive" class="form-select">
                                                    <option value="true" ${voucher.active ? 'selected' : ''}>Active</option>
                                                    <option value="false" ${voucher.active ? 'selected' : ''}>De-Active</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="discountType" class="form-select" onchange="onDiscountTypeChange(this)">
                                                    ...
                                                    <option value="AMOUNT" ${voucher.discountType == 'AMOUNT' ? 'selected' : ''}>Amount (VND)</option>
                                                </select>
                                            </div>

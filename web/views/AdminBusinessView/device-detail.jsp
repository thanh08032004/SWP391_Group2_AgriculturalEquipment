            ...
            <div class="card shadow-sm rounded-3">
                ...
                <div class="card-body">
                    <div class="text-center mb-4">
                        <img src="${pageContext.request.contextPath}/assets/images/devices/${empty device.image ? 'default.png' : device.image}"
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${device.price != null}">
                                        <strong class="text-success">${device.price} VNĐ</strong>
                                    </c:when>
                                    <c:otherwise>

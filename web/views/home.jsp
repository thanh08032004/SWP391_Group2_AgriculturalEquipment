        ...
        <div class="banner-section" style="background-color: #FEF6F0;">
            <div class="container">
                <div class="owl-carousel owl-theme banner-slider">
                    <div class="item"> 
                        <div class="banner-item" style="background-image: url(./assets/images/banner/bn.png)">
                            <div class="container">
                                <div class="row">
                    ...
                    <div class="item"> 
                        <div class="banner-item" style="background-image: url(./assets/images/banner/bn2.png)">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-8 col-lg-6">
                                        <div class="banner-content text-left">
                    ...
                    <div class="item"> 
                        <div class="banner-item" style="background-image: url(./assets/images/banner/bn1.png)">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-8 col-lg-6">
                                        <div class="banner-content text-left">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-4">
                        <div class="hero-banner-item rounded">
                            <img src="assets/images/banner/mc.png" alt="banner">
                            <div class="hero-banner-item-overly">
                                <div class="hero-banner-item-overly-full">
                                    <h4>Exclusive Sale</h4>
                                    <h3>Cheap</h3>
                                    <a class="btn btn-primary mt-2" href="shop.html">Go to voucher</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-4">
                        <div class="hero-banner-item rounded">
                            <img src="assets/images/banner/mc1.png" alt="banner">
                            <div class="hero-banner-item-overly">
                                <div class="hero-banner-item-overly-full">
                                    <h4>Super Sale</h4>
                                    <h3>Safe</h3>
                                    <a class="btn btn-primary mt-2" href="shop.html">Go to mantainance</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="blog-header">
                                <div class="mb-3">
                                    <a href="blog-single.html">
                                        <div class="img-zoom">
                                            <img src="./assets/images/banner/fb.png" alt="eCommerce Html Template" class="img-fluid w-100">
                                        </div>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="blog-wraper">
                            <div class="blog-header">
                                <div class="mb-3">
                                    <a href="blog-single.html">
                                        <div class="img-zoom">
                                            <img src="./assets/images/banner/fb1.png" alt="eCommerce Html Template" class="img-fluid w-100">
                                        </div>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="blog-wraper">
                            <div class="blog-header">
                                <div class="mb-3">
                                    <a href="blog-single.html">
                                        <div class="img-zoom">
                                            <img src="./assets/images/banner/fb2.png" alt="eCommerce Html Template" class="img-fluid w-100">
                                        </div>
                                    </a>
                                </div>
                            </div>

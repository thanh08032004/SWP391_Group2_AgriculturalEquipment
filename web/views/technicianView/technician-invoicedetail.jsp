    ...
    <body>
        ...
        <div class="container mt-5 mb-5">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <c:if test="${invoice.paymentStatus ne 'PAID'}">
                                        <form action="${pageContext.request.contextPath}/technician/invoicedetail"
            ...
            <div class="text-end mt-3">
                <a href="${pageContext.request.contextPath}/technician/invoicelist"

        ...
        <jsp:include page="/common/header.jsp"></jsp:include>
            <div class="admin-layout d-flex">
                <div class="admin-content p-4 w-100">
                    ...
                    <a href="${pageContext.request.contextPath}/customer/maintenance/done" class="btn btn-outline-secondary btn-sm">
        ...
        <jsp:include page="/common/scripts.jsp"></jsp:include>
            ...
            <script>
                function viewDeviceDetail(id) {
                    ...
                    fetch('${pageContext.request.contextPath}/customer/maintenance/detail?action=getDeviceDetail&deviceId=' + id)
                            .then(res => res.json())
                            .then(dev => {
                            ...
                            <table class="table table-sm table-borderless">
                                <tr><td width="35%" class="text-muted">Name:</td><td class="fw-bold">\${dev.name}</td></tr>
                                <tr><td class="text-muted">Model:</td><td>\${dev.model}</td></tr>
                                <tr><td class="text-muted">Serial:</td><td><code>\${dev.serial}</code></td></tr>
                ...
                function viewCustomerDetail(id) {
                    ...
                    fetch('${pageContext.request.contextPath}/customer/maintenance/detail?action=getCustomerDetail&customerId=' + id)
                            .then(res => res.json())
                            .then(cus => {

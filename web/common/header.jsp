...
<c:if test="${not empty sessionScope.userRole}">
    <c:choose>
        ...
        <c:when test="${sessionScope.userRole == 'ADMIN_BUSINESS'}">
            <c:set var="roleHome" value="${pageContext.request.contextPath}/admin-business/reports" />
        </c:when>
                    ...
                    <ul class="navbar-nav mx-auto">
                        <c:if test="${empty sessionScope.userRole || sessionScope.userRole == 'CUSTOMER'}">
                            ...
                            <c:if test="${sessionScope.userRole == 'CUSTOMER'}">
                                ...
                                <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/customer/maintenance/done">History</a></li>
